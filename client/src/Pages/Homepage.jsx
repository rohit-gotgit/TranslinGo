              ...
              <TabsContent value="login" className="flex flex-col gap-4 mt-6">
                <div>
                  <Input
                    ...
                    type="email"
                    value={email}
                    className={`rounded-full p-6 ${emailError ? 'border-red-500' : ''}`}
                ...
                <div>
                  <Input
                    ...
                    type="password"
                    value={password}
                    className={`rounded-full p-6 ${passwordError ? 'border-red-500' : ''}`}
                    onChange={(e) => handlePasswordChange(e.target.value)}
                    onBlur={() => {
                      if (password) handlePasswordChange(password)
                    }}
                  />
                  {passwordError && <p className="text-red-500 text-sm mt-1 px-2">{passwordError}</p>}
                </div>
                <LoadingButton
              ...
              <TabsContent value="signup" className="flex flex-col gap-4 mt-6">
                ...
                <div>
                  <Input
                    ...
                    className={`rounded-full p-6 ${confirmPasswordError ? 'border-red-500' : ''}`}
                    onChange={(e) => handleConfirmPasswordChange(e.target.value)}
                    onBlur={() => {
                      if (confirmPassword) handleConfirmPasswordChange(confirmPassword)
                    }}
                  />
                  {confirmPasswordError && <p className="text-red-500 text-sm mt-1 px-2">{confirmPasswordError}</p>}
                </div>
                <LoadingButton
                  className="rounded-full p-6 bg-indigo-600 hover:bg-indigo-700 transition-all duration-300 text-white"
